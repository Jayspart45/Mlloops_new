...
from singularity_loop.core.utils.params import cast_bool_from_str
from singularity_loop.core.utils.common import load_func
...
def get_fields_for_evaluation(prepare_params, user):
    ...
    if fields:
        from singularity_loop.data_manager.functions import TASKS
