...
from singularity_loop.core.utils.io import get_data_dir
from singularity_loop.core.utils.params import get_bool_env, get_env, get_env_list_int
...
DJANGO_DB = 'default'
DATABASE_NAME_DEFAULT = os.path.join(BASE_DATA_DIR, 'singularity_loop.sqlite3')
...
# EDITOR = singularity-loop-frontend repository
