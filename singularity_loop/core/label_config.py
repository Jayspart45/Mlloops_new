...
from singularity_loop.core.utils.io import find_file
from singularity_loop.core.utils.exceptions import (
...
def parse_config(config_string):
    ...
    """
    logger.warning("Using deprecated method - switch to singularity_loop.tools.label_config.parse_config!")
