...
from singularity_loop.core.utils.params import get_bool_env, get_all_env_with_prefix
from singularity_loop.core.utils.io import find_node
...
if settings.FEATURE_FLAGS_FROM_FILE:
    ...
    package_name = 'singularity_loop' if settings.VERSION_EDITION == 'Community Edition' else 'label_studio_enterprise'
